...
def import_data(file_path):
    ...
    print(f"🚀 Importation de {len(data)} nouvelles offres depuis {file_path}...")
    ...
    for i, item in enumerate(data):
        try:
            ...
            if not source_url:
                source_url = f"extraction5_id_{i}_{datetime.now().timestamp()}"
            ...
            # Insert into database (using upsert in insert_job)
...
if __name__ == "__main__":
    FILE_PATH = "/Users/mac/DJORSSI-MATCH/scraper/exaction/extraction5.json"
